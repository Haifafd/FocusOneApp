...
import { useAuth } from "../contexts/AuthContext"; // استيراد الـ AuthContext لجلب بيانات المستخدم
...
const HomeScreen = () => {
  ...
  // استخراج الاسم من الايميل أو من بيانات المستخدم
  // إذا لم يتوفر اسم، سنعرض "Guest" كاحتياط
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {/* بطاقة الهدف (Progress Card) - بدون تغيير في الواجهة */}
      ...
      {/* بطاقة المهمة (Task Card) - بدون تغيير في الواجهة */}
...
// ... التنسيقات (Styles) تبقى كما هي دون تغيير
